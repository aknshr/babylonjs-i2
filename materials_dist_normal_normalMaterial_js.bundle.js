...
/* harmony import */ var core_Misc_decorators_serialization__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core/Misc/decorators.serialization */ "../core/dist/Misc/decorators.serialization.js");
...
/* harmony import */ var core_Materials_materialDefines__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! core/Materials/materialDefines */ "../core/dist/Materials/materialDefines.js");
/* harmony import */ var core_Materials_pushMaterial__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core/Materials/pushMaterial */ "../core/dist/Materials/pushMaterial.js");
/* harmony import */ var core_Materials_materialFlags__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core/Materials/materialFlags */ "../core/dist/Materials/materialFlags.js");
/* harmony import */ var core_Buffers_buffer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! core/Buffers/buffer */ "../core/dist/Buffers/buffer.js");
/* harmony import */ var core_scene__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! core/scene */ "../core/dist/scene.js");
/* harmony import */ var core_Misc_typeStore__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! core/Misc/typeStore */ "../core/dist/Misc/typeStore.js");
/* harmony import */ var _normal_fragment__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./normal.fragment */ "../materials/dist/normal/normal.fragment.js");
/* harmony import */ var _normal_vertex__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./normal.vertex */ "../materials/dist/normal/normal.vertex.js");
/* harmony import */ var core_Materials_effectFallbacks__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! core/Materials/effectFallbacks */ "../core/dist/Materials/effectFallbacks.js");
/* harmony import */ var core_Materials_clipPlaneMaterialHelper__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! core/Materials/clipPlaneMaterialHelper */ "../core/dist/Materials/clipPlaneMaterialHelper.js");
/* harmony import */ var core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! core/Materials/materialHelper.functions */ "../core/dist/Materials/materialHelper.functions.js");
/* provided dependency */ var __react_refresh_utils__ = __webpack_require__(/*! ../../../node_modules/@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js */ "../../../node_modules/@pmmmwh/react-refresh-webpack-plugin/lib/runtime/RefreshUtils.js");
__webpack_require__.$Refresh$.runtime = __webpack_require__(/*! ../../../node_modules/react-refresh/runtime.js */ "../../../node_modules/react-refresh/runtime.js");
...
class NormalMaterialDefines extends core_Materials_materialDefines__WEBPACK_IMPORTED_MODULE_4__.MaterialDefines {
    constructor() {
        super();
        this.DIFFUSE = false;
...
class NormalMaterial extends core_Materials_pushMaterial__WEBPACK_IMPORTED_MODULE_5__.PushMaterial {
    constructor(name, scene) {
        super(name, scene);
        this.diffuseColor = new core_Maths_math_color__WEBPACK_IMPORTED_MODULE_3__.Color3(1, 1, 1);
    ...
    isReadyForSubMesh(mesh, subMesh, useInstances) {
        ...
        if (defines._areTexturesDirty) {
            ...
            if (scene.texturesEnabled) {
                if (this._diffuseTexture && core_Materials_materialFlags__WEBPACK_IMPORTED_MODULE_6__.MaterialFlags.DiffuseTextureEnabled) {
        ...
        // Misc.
        (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.PrepareDefinesForMisc)(mesh, scene, this._useLogarithmicDepth, this.pointsCloud, this.fogEnabled, this.needAlphaTestingForMesh(mesh), defines, undefined, undefined, undefined, this._isVertexOutputInvariant);
        // Lights
        defines._needNormals = true;
        (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.PrepareDefinesForLights)(scene, mesh, defines, false, this._maxSimultaneousLights, this._disableLighting);
        // Values that need to be evaluated on every frame
        (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.PrepareDefinesForFrameBoundValues)(scene, engine, this, defines, useInstances ? true : false, null, subMesh.getRenderingMesh().hasThinInstances);
        defines.LIGHTING = !this._disableLighting;
        // Attribs
        (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.PrepareDefinesForAttributes)(mesh, defines, true, true);
        // Get correct effect
        if (defines.isDirty) {
            defines.markAsProcessed();
            scene.resetCachedMaterial();
            // Fallbacks
            const fallbacks = new core_Materials_effectFallbacks__WEBPACK_IMPORTED_MODULE_12__.EffectFallbacks();
            if (defines.FOG) {
                fallbacks.addFallback(1, "FOG");
            }
            (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.HandleFallbacksForShadows)(defines, fallbacks);
            if (defines.NUM_BONE_INFLUENCERS > 0) {
                fallbacks.addCPUSkinningFallback(0, mesh);
            }
            defines.IMAGEPROCESSINGPOSTPROCESS = scene.imageProcessingConfiguration.applyByPostProcess;
            //Attributes
            const attribs = [core_Buffers_buffer__WEBPACK_IMPORTED_MODULE_7__.VertexBuffer.PositionKind];
            if (defines.NORMAL) {
                attribs.push(core_Buffers_buffer__WEBPACK_IMPORTED_MODULE_7__.VertexBuffer.NormalKind);
            }
            if (defines.UV1) {
                attribs.push(core_Buffers_buffer__WEBPACK_IMPORTED_MODULE_7__.VertexBuffer.UVKind);
            }
            if (defines.UV2) {
                attribs.push(core_Buffers_buffer__WEBPACK_IMPORTED_MODULE_7__.VertexBuffer.UV2Kind);
            }
            (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.PrepareAttributesForBones)(attribs, mesh, defines, fallbacks);
            (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.PrepareAttributesForInstances)(attribs, defines);
            ...
            (0,core_Materials_clipPlaneMaterialHelper__WEBPACK_IMPORTED_MODULE_13__.AddClipPlaneUniforms)(uniforms);
            (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.PrepareUniformsAndSamplersList)({
    ...
    bindForSubMesh(world, mesh, subMesh) {
        ...
        // Bones
        (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.BindBonesParameters)(mesh, this._activeEffect);
        if (this._mustRebind(scene, effect, subMesh)) {
            // Textures
            if (this.diffuseTexture && core_Materials_materialFlags__WEBPACK_IMPORTED_MODULE_6__.MaterialFlags.DiffuseTextureEnabled) {
                this._activeEffect.setTexture("diffuseSampler", this.diffuseTexture);
                this._activeEffect.setFloat2("vDiffuseInfos", this.diffuseTexture.coordinatesIndex, this.diffuseTexture.level);
                this._activeEffect.setMatrix("diffuseMatrix", this.diffuseTexture.getTextureMatrix());
            }
            // Clip plane
            (0,core_Materials_clipPlaneMaterialHelper__WEBPACK_IMPORTED_MODULE_13__.BindClipPlane)(effect, this, scene);
            // Point size
            if (this.pointsCloud) {
            ...
            if (this._useLogarithmicDepth) {
                (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.BindLogDepth)(defines, effect, scene);
            }
        ...
        if (scene.lightsEnabled && !this.disableLighting) {
            (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.BindLights)(scene, mesh, this._activeEffect, defines);
        }
        // View
        if (scene.fogEnabled && mesh.applyFog && scene.fogMode !== core_scene__WEBPACK_IMPORTED_MODULE_8__.Scene.FOGMODE_NONE) {
            this._activeEffect.setMatrix("view", scene.getViewMatrix());
        }
        // Fog
        (0,core_Materials_materialHelper_functions__WEBPACK_IMPORTED_MODULE_14__.BindFogParameters)(scene, mesh, this._activeEffect);
    ...
    clone(name) {
        return core_Misc_decorators_serialization__WEBPACK_IMPORTED_MODULE_2__.SerializationHelper.Clone(() => new NormalMaterial(name, this.getScene()), this);
    }
    serialize() {
    ...
    static Parse(source, scene, rootUrl) {
        return core_Misc_decorators_serialization__WEBPACK_IMPORTED_MODULE_2__.SerializationHelper.Parse(() => new NormalMaterial(source.name, scene), source, scene, rootUrl);
    }
}
...
(0,core_Misc_typeStore__WEBPACK_IMPORTED_MODULE_9__.RegisterClass)("BABYLON.NormalMaterial", NormalMaterial);
