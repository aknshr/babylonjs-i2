...
/* harmony import */ var _Misc_decorators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Misc/decorators */ "../core/dist/Misc/decorators.js");
/* harmony import */ var _Misc_decorators_serialization__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Misc/decorators.serialization */ "../core/dist/Misc/decorators.serialization.js");
...
class MorphTarget {
    ...
    name, influence = 0, scene = null) {
         ...
         */
        this.onInfluenceChanged = new _Misc_observable__WEBPACK_IMPORTED_MODULE_1__.Observable();
        /** @internal */
        this._onDataLayoutChanged = new _Misc_observable__WEBPACK_IMPORTED_MODULE_1__.Observable();
     ...
     */
    clone() {
        const newOne = _Misc_decorators_serialization__WEBPACK_IMPORTED_MODULE_5__.SerializationHelper.Clone(() => new MorphTarget(this.name, this.influence, this._scene), this);
    ...
    serialize() {
        ...
        // Animations
        _Misc_decorators_serialization__WEBPACK_IMPORTED_MODULE_5__.SerializationHelper.AppendSerializedAnimations(this, serializationObject);
    ...
    static Parse(serializationObject, scene) {
        ...
        if (serializationObject.animations) {
            for (let animationIndex = 0; animationIndex < serializationObject.animations.length; animationIndex++) {
                ...
                const internalClass = (0,_Misc_typeStore__WEBPACK_IMPORTED_MODULE_6__.GetClass)("BABYLON.Animation");
                if (internalClass) {
    ...
    static FromMesh(mesh, name, influence) {
        ...
        result.setPositions(mesh.getVerticesData(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.PositionKind));
        if (mesh.isVerticesDataPresent(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.NormalKind)) {
            result.setNormals(mesh.getVerticesData(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.NormalKind));
        }
        if (mesh.isVerticesDataPresent(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.TangentKind)) {
            result.setTangents(mesh.getVerticesData(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.TangentKind));
        }
        if (mesh.isVerticesDataPresent(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.UVKind)) {
            result.setUVs(mesh.getVerticesData(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.UVKind));
        }
        if (mesh.isVerticesDataPresent(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.UV2Kind)) {
            result.setUV2s(mesh.getVerticesData(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.UV2Kind));
        }
        if (mesh.isVerticesDataPresent(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.ColorKind)) {
            result.setColors(mesh.getVerticesData(_Buffers_buffer__WEBPACK_IMPORTED_MODULE_3__.VertexBuffer.ColorKind));
        }
        return result;
    }
}
(0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
    (0,_Misc_decorators__WEBPACK_IMPORTED_MODULE_4__.serialize)()
